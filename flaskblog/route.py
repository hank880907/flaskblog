...
@app.route('/post/<int:post_id>', methods=['GET', 'POST']) # the post_id is defined in the html.
def post(post_id):
...
@app.route('/post/<int:post_id>/delete', methods=['POST']) # the post_id is defined in the html.
@login_required
